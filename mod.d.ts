...
import MAX_NTH_DOUBLE_FACTORIAL = require( '@stdlib/constants-float64-max-nth-double-factorial' );
import MAX_NTH_FACTORIAL = require( '@stdlib/constants-float64-max-nth-factorial' );
...
import MAX_SAFE_NTH_DOUBLE_FACTORIAL = require( '@stdlib/constants-float64-max-safe-nth-double-factorial' );
import MAX_SAFE_NTH_FACTORIAL = require( '@stdlib/constants-float64-max-safe-nth-factorial' );
...
import MAX_SAFE_NTH_TRIBONACCI = require( '@stdlib/constants-float64-max-safe-nth-tribonacci' );
...
import NUM_HIGH_WORD_SIGNIFICAND_BITS = require( '@stdlib/constants-float64-num-high-word-significand-bits' );
